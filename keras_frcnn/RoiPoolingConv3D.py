...
class RoiPoolingConv3D(Layer):
    ...
    def __init__(self, pool_size, num_rois, **kwargs):
        ...
        super(RoiPoolingConv3D, self).__init__(**kwargs)
    ...
    def call(self, x, mask=None):
        ...
        for roi_idx in range(self.num_rois):
            ...
            if self.dim_ordering == 'th':
                ...
                rs = tf.image.resize_images(img[:, y:y + h, x:x + w, z:z + d,:], (self.pool_size, self.pool_size, self.pool_size))
                outputs.append(rs)
    ...
    def get_config(self):
        ...
        base_config = super(RoiPoolingConv3D, self).get_config()
